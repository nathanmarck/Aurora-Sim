...
{
    if (((ILSL_Api)m_apis["ll"]).llStringLength(msg) > new LSL_Types.LSLInteger(36))
    {
    }
    else
    {
...
{
    ((ILSL_Api)m_apis["ll"]).llSay(new LSL_Types.LSLInteger(0), new LSL_Types.LSLString("FATAL: Cannot connect to server..."));
